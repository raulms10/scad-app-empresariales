                  ...
                  else // En caso que si exista el inmueble
                  {
                    ...
                    else // Ahora, si el calculo de los dias fue correcto entonces
                    {
                      ...
                      else // Si no hay solapamiento entonces
                      {
                        ...
                        //val resultadoReserva = query.executeUpdate(s"""INSERT INTO Booking VALUES (${idHome.get}, '${checkIn}', '${checkOut}', "${emailToken.get}", NULL);""")
                        val resultadoReserva = query.executeUpdate(s"""INSERT INTO Booking VALUES (${idHome.get}, '${checkIn}'+INTERVAL 1 DAY, '${checkOut}'+INTERVAL 1 DAY, "${emailToken.get}", NULL);""")
                        ...
                        //val resultadoReserva = query.executeUpdate(s"""INSERT INTO Booking VALUES (${idHome.get}, '${checkIn}', '${checkOut}', "${clientUID}", NULL);""")
                        val resultadoReserva = query.executeUpdate(s"""INSERT INTO Booking VALUES (${idHome.get}, '${checkIn}'+INTERVAL 1 DAY, '${checkOut}'+INTERVAL 1 DAY, "${clientUID}", NULL);""")
                        */
                        // -------------------------------------------------------------
